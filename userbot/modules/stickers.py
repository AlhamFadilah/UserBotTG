...
KANGING_STR = [
    ...
    "Aku kang y kakak :)",
    "Saat nya Colong sticker...",
    "Curry Dulu Ea...",
    "Ambil Ah Bagus nih Stiker...",
    "Wew Izin Colong ya hahahahaha...",
    "Bagus ni Stiker nya , Cury ah!..",
    "Mampus gw colong stikernya.",
    "No Curry No life...",
    "Colong stiker. . .",
    "Imprisoning this sticker...\nit'll look good in my pack",
    "Gua ambil nih stiker mayan",
    "Stiker bagus nih Colong ahh!",
    "Mencolong Stiker...",
]
